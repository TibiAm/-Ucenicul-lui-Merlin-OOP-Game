...
{
    private static Game instance=null;    //instanta sigleton
    ...
    private BufferedImage testImage; // fisier temporar utilizat pt incaracarea fundalului
    ...
    public State menuState, winState, helpState, loseState;
    public GameState level1_Part1, level1_Part2, level2_Part1, level2_Part2, level3_Part1;
    ...
    {
        /*wnd = new GameWindow("Ucenicul lui Merlin", 768, 384);
        ...
        db              = new DataBase();
        level1_Part1    = new Level1_Part1(refLinks);
        level1_Part2    = new Level1_Part2(refLinks);
        level2_Part1    = new Level2_Part1(refLinks);
        level2_Part2    = new Level2_Part2(refLinks);
        level3_Part1    = new Level3_Part1(refLinks);
        helpState       = new HelpState(refLinks);
        loseState       = new LoseState(refLinks);
    ...
    /*! \fn public synchronized static Game GetInstance(String title, int width, int height)
        \brief Returneaza instanta singleton-ului

        \param titel Titlul jocului.
    ...
    /*! \fn public DataBase getDB()
        \brief Returneaza o referinta catre baza de date.
     */
